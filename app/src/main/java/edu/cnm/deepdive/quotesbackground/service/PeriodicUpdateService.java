...
public class PeriodicUpdateService
  ...
  private final String pollingInternalPrefKey;
  ...
  private PeriodicUpdateService() {
    ...
    pollingInternalPrefKey = context.getString(R.string.poll_interval_pref_key);
  ...
  public synchronized void schedule() {
    int pollingInterval = preferences.getInt(pollingInternalPrefKey, defaultPollingInterval);
  ...
  public void onSharedPreferenceChanged(SharedPreferences sharedPreferences, String key) {
    if (key.equals(pollingInternalPrefKey)) {
      schedule();
    }
  }
